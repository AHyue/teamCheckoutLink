...
const translations = {
  zh: {
    ...
    navFeatures: '功能', navPrivacy: '隐私', navSource: '源代码', installChrome: '安装 Chrome 版', viewSource: '查看 GitHub 源码',
    eyebrow: '独立开源浏览器扩展 · Chrome 版已上架',
    ...
    heroNote: 'Chrome 网上应用店版本：1.0.0。其他商店链接将在确认发布后补充。',
    ...
    stepOneTitle: '安装并打开受支持的网页', stepOneText: 'Chrome 版可从 Chrome 网上应用店安装；然后访问支持的工作区网页。',
    ...
    closingEyebrow: 'Chrome · 版本 1.0.0', closingTitle: '准备好开始了吗？',
  ...
  en: {
    ...
    navFeatures: 'Features', navPrivacy: 'Privacy', navSource: 'Source', installChrome: 'Get it for Chrome', viewSource: 'View on GitHub',
    eyebrow: 'Independent open-source extension · Available for Chrome',
    ...
    heroNote: 'Chrome Web Store version: 1.0.0. Links for other stores will be added after publication is confirmed.',
    ...
    stepOneTitle: 'Install and open a supported page', stepOneText: 'Install the Chrome version from the Chrome Web Store, then visit a supported workspace page.',
    ...
    closingEyebrow: 'Chrome · Version 1.0.0', closingTitle: 'Ready to get started?',
